...
extern "C" __global__ void __raygen__renderFrame() {
    if (optixLaunchParams.frame_id == 0 && optixGetLaunchIndex().x == 0 &&
    ...
    int frameID = optixLaunchParams.frame_id;
    ...
    const unsigned fb_index = ix + iy * optixLaunchParams.fb_size.x;
    optixLaunchParams.color_buffer[fb_index] = make_float4(r, g, b, 1.0f);
}
