    ...
    AllocT: 'a + Allocator,
{
    ...
    mesh: TriangleMesh,
    vertex_buffer: Rc<optix::Buffer<'a, AllocT, V3f32>>,
    index_buffer: Rc<optix::Buffer<'a, AllocT, V3i32>>,
    ...
    AllocT: 'a + Allocator,
{
    pub fn new(
        ...
        let index_buffer = Rc::new(
            optix::Buffer::new(&mesh.index, MemTags::IndexBuffer as u64, alloc)
                .unwrap(),
        );
