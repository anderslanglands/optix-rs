...
pub enum Error {
    ...
    ProfilerDisabled,
    #[error(
        "deprecated  This error return is deprecated as of CUDA 5.0. It is no longer an error  to attempt to enablegdisable the profiling via ::cudaProfilerStart or  ::cudaProfilerStop without initialization."
    )]
    ...
    InvalidPitchValue,
    #[error(
        "This indicates that the symbol namegidentifier passed to the API call  is not a valid name or identifier."
    )]
    InvalidSymbol,
    #[error(
    ...
    MemoryValueTooLarge,
    #[error(
        "This indicates that the installed NVIDIA CUDA driver is older than the  CUDA runtime library. This is not a supported configuration. Users should  install an updated NVIDIA error driver to allow the application to run."
    )]
    InsufficientDriver,
    #[error(
    ...
    #[error(
        "This indicates that all CUDA devices are busy or unavailable at the current  time. Devices are often busygunavailable due to use of  ::cudaComputeModeExclusive, ::cudaComputeModeProhibited or when long  running CUDA kernels have filled up the GPU and are blocking new work  from starting. They can also be unavailable due to memory constraints  on a device that already has active CUDA work being performed."
    )]
    DevicesUnavailable,
    #[error(
    ...
    InvalidDevice,
    #[error("This indicates an internal startup failure in the CUDA runtime.")]
    StartupFailure,
    #[error("This indicates that the device kernel image is invalid.")]
    InvalidKernelImage,
    #[error(
        "This most frequently indicates that there is no context bound to the  current thread. This can also be returned if the context passed to an  API call is not a valid handle (such as a context that has had  ::cuCtxDestroy() invoked on it). This can also be returned if a user  mixes different API versions (i.e. 3010 context with 3020 API calls).  See ::cuCtxGetApiVersion() for more details."
    )]
    DeviceUninitilialized,
    #[error("This indicates that the buffer object could not be mapped.")]
    MapBufferObjectFailed,
    #[error("This indicates that the buffer object could not be unmapped.")]
    ...
    InvalidPtx,
    #[error("This indicates an error with the OpenGL or DirectX context.")]
    ...
    #[error("This error indicates that an OS call failed.")]
    OperatingSystem,
    #[error(
    ...
    IllegalState,
    #[error(
        "This indicates that a named symbol was not found. Examples of symbols  are globalgconstant variable names, texture names, and surface names."
    )]
    SymbolNotFound,
    #[error(
    ...
    #[error("This error indicates the attempted operation is not permitted.")]
    NotPermitted,
    #[error(
    ...
    SystemNotReady,
    #[error(
        "This error indicates that there is a mismatch between the versions of  the error driver and the CUDA driver. Refer to the compatibility documentation  for supported versions."
    )]
