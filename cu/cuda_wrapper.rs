...
impl CUlimit_enum {
    ...
    pub const CU_LIMIT_DEV_RUNTIME_PENDING_LAUNCH_COUNT: CUlimit_enum =
        CUlimit_enum(4);
}
impl CUlimit_enum {
...
impl cudaError_enum {
    ...
    #[doc = " execution."]
    pub const CUDA_ERROR_NVLINK_UNCORRECTABLE: cudaError_enum =
        cudaError_enum(220);
}
impl cudaError_enum {
...
pub type CUoccupancyB2DSize = ::std::option::Option<
    unsafe extern "C" fn(blockSize: ::std::os::raw::c_int) -> size_t,
>;
